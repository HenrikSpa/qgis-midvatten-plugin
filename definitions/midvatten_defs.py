...
def geocolorsymbols():
    ...
    """
    res1, dict_qt = get_sql_result_as_dict(
        "select strata, brush_qt, color_qt from zz_stratigraphy_plots"
    )
...
def get_subset_of_tables_fr_db(category="obs_points"):
    ...
    if category == "obs_points":
        ...
        return ["obs_lines", "vlf_data", "seismic_data", "tem_data", "profile_images"]
...
def hydrocolors():
    ...
    """
    res, dict_qt1 = get_sql_result_as_dict(
...
def plot_types_dict(international="no"):
    """
        ...
        if international == "no" and getcurrentlocale() == "sv_SE":
            ...
            dictionary = dict(
                [
                    ("Okänt", None),
                    ("Berg", ("berg", "b", "rock", "ro")),
                    ("Grovgrus", ("grovgrus", "grg", "coarse gravel", "cgr")),
                    ("Grus", ("grus", "gr", "gravel")),
                    ("Mellangrus", ("mellangrus", "grm", "medium gravel", "mgr")),
                    ("Fingrus", ("fingrus", "grf", "fine gravel", "fgr")),
                    ("Grovsand", ("grovsand", "sag", "coarse sand", "csa")),
                    ("Sand", ("sand", "sa")),
                    ("Mellansand", ("mellansand", "sam", "medium sand", "msa")),
                    ("Finsand", ("finsand", "saf", "fine sand", "fsa")),
                    ("Silt", ("silt", "si")),
                    ("Lera", ("lera", "ler", "le", "clay", "cl")),
                    ("Morän", ("morän", "moran", "mn", "till", "ti")),
                    ("Torv", ("torv", "t", "peat", "pt")),
                    (
                        "Fyll",
                        ("fyll", "fyllning", "f", "made ground", "mg", "land fill"),
                    ),
                ]
            )
        else:
            ...
            dictionary = dict(
                [
                    ("Unknown", None),
                    ("Rock", ("berg", "b", "rock", "ro")),
                    ("Coarse gravel", ("grovgrus", "grg", "coarse gravel", "cgr")),
                    ("Gravel", ("grus", "gr", "gravel")),
                    ("Medium gravel", ("mellangrus", "grm", "medium gravel", "mgr")),
                    ("Fine gravel", ("fingrus", "grf", "fine gravel", "fgr")),
                    ("Coarse sand", ("grovsand", "sag", "coarse sand", "csa")),
                    ("Sand", ("sand", "sa")),
                    ("Medium sand", ("mellansand", "sam", "medium sand", "msa")),
                    ("Fine sand", ("finsand", "saf", "fine sand", "fsa")),
                    ("Silt", ("silt", "si")),
                    ("Clay", ("lera", "ler", "le", "clay", "cl")),
                    ("Till", ("morän", "moran", "mn", "till", "ti")),
                    ("Peat", ("torv", "t", "peat", "pt")),
                    (
                        "Fill",
                        ("fyll", "fyllning", "f", "made ground", "mg", "land fill"),
...
def get_last_used_quality_instruments():
    ...
    [
        result_dict.setdefault(row[0], {}).setdefault(row[3], []).append(row)
        for row in result
    ]
...
specific_table_info = {
    "obs_lines": """The geometry column supports WKT ("well known text") of type LINESTRING and\nthe geometries must have a SRID that's supported by database.""",
        ...
        if current_locale != "sv_SE":
            ...
            input_fields_groups = [
                ...
                [
                    1,
                    (
                        ("input_field_group_list", ['{"comment": {"type": "text"}}']),
                        ("sublocation_suffix", "comment"),
                    ),
                ],
                [
            ...
            input_fields_groups = [
                ...
                [
                    1,
                    (
                        ("input_field_group_list", ['{"kommentar": {"type": "text"}}']),
                        ("sublocation_suffix", "kommentar"),
                    ),
                ],
                [
...
def secplot_default_template():
    ...
    loaded_template["dems_Axes_plot"] = {
        "DEFAULT": {"marker": "None", "linestyle": "-", "linewidth": 1}
    }
    loaded_template["drillstop_Axes_plot"] = {
        "marker": "^",
        "markersize": 8,
        "linestyle": "",
        "color": "black",
    ...
    loaded_template["grid_Axes_grid"] = {
        "b": True,
        "which": "both",
        "color": "0.65",
        "linestyle": "-",
    }
    loaded_template["layer_Axes_annotate"] = {
        "xytext": (5, 0),
    ...
    loaded_template["legend_Axes_legend"] = {"loc": 0, "framealpha": 1, "fontsize": 10}
    ...
    loaded_template["obsid_Axes_annotate"] = {
        "xytext": (0, 10),
        "textcoords": "offset points",
        "ha": "center",
        "va": "top",
    ...
    loaded_template["obsid_Axes_bar"] = {
        "edgecolor": "black",
        "fill": False,
        "linewidth": 0.5,
    }
...
def custplot_default_template():
    default = {
        "Axes_axhline": {},
        "Axes_axvline": {},
        "Axes_plot": {"linewidth": 1, "markersize": 6, "zorder": 8},
        "Axes_plot_date": {"linewidth": 1, "markersize": 6, "zorder": 8},
        "Axes_set_title": {"label": ""},
        "Axes_set_xlabel": {"fontsize": 10, "xlabel": ""},
        "Axes_set_ylabel": {"fontsize": 10, "ylabel": ""},
        "Axes_tick_param": {"axis": "both", "labelsize": 10},
        "Figure_add_subplot": {},
...
def piperplot_style():
    return os.path.join(
        os.path.dirname(__file__), "mpl_styles", "midv_piperplot.mplstyle"
    )


def piperplot2_style():
    return os.path.join(
        os.path.dirname(__file__), "mpl_styles", "midv_piperplot2.mplstyle"
    )

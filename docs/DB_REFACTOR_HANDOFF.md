...
- Section 2.3: Ruff format applied; type hints in `tools/utils/db_utils/` updated (List/Tuple/Dict → list/tuple/dict).
...
3. **Optional:** If project style requires it, resolve remaining ruff in `tools/utils/db_utils/` (UP031 percent format, W291 trailing whitespace). Optional: update i18n under `i18n/` if user-facing strings change.

...
class TestCalculateStatistics(utils_for_tests.MidvattenTestSpatialiteDbSv):
    ...
    def test_calculate_statistics(
        self, mock_selected_features, mock_iface, mock_messagebar
    ):
        ...
        db_utils.sql_alter_db(
            """INSERT INTO w_levels(obsid, date_time, meas) VALUES('1', '2017-01-01', '1')"""
        )
        db_utils.sql_alter_db(
            """INSERT INTO w_levels(obsid, date_time, meas) VALUES('1', '2017-01-02', '3')"""
        )
        db_utils.sql_alter_db(
            """INSERT INTO w_levels(obsid, date_time, meas) VALUES('1', '2017-01-03', '5')"""
        )
        db_utils.sql_alter_db(
            """INSERT INTO w_levels(obsid, date_time, meas) VALUES('2', '2017-01-04', '2')"""
        )
        db_utils.sql_alter_db(
            """INSERT INTO w_levels(obsid, date_time, meas) VALUES('2', '2017-01-05', '8')"""
        )
        db_utils.sql_alter_db(
            """INSERT INTO w_levels(obsid, date_time, meas) VALUES('2', '2017-01-06', '9')"""
        )
        db_utils.sql_alter_db(
            """INSERT INTO w_levels(obsid, date_time, meas) VALUES('2', '2017-01-07', '10')"""
        )
        ...
        ref = call.info(
            bar_msg="Statistics for table w_levels column meas done, see log for results.",
            button=True,
            duration=15,

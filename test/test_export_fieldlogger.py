...
class TestExportFieldloggerNoDb(MidvattenTestBase):
    ...
    def test_get_stored_settings():
        ...
        mock_ms.settingsdict = {
            "test_settings_key": '((0, ("final_parameter_name", "testname"), ("test", "gotten_test")), (1, ("key1", "value1"), ("key2", "value2"), ("key3", "value3")))'
        }
        settingskey = "test_settings_key"
        stored_settings = create_test_string(
            common_utils.get_stored_settings(mock_ms, settingskey)
        )
    ...
    def test_save_stored_settings():
        ...
        stored_settings = [
            (
                0,
                (
                    ("input_field_group_list", ["p1.u1;it1:h1", "p2.u2;it2:h2"]),
                    ("key0_2", "value0_2"),
                ),
            ),
    ...
    def test_get_stored_settings_parameter_browser():
        mock_ms = MagicMock()
        mock_ms.settingsdict = {
            "fieldlogger_export_parameter_browser": '((0, ("input_field_group_list", ("p1.u1;input;hint", "np2.u2;input2;hint2"), ), ), )'
        }
        ...
        reference_string = (
            "((0, (input_field_group_list, (p1.u1;input;hint, np2.u2;input2;hint2))))"
        )
        assert stored_settings == reference_string
    ...
    def test_update_stored_settings():
        ...
        parameter_groups[0].get_settings.return_value = (
            ("key0_1", "value0_1"),
            ("key0_2", "value0_2"),
        )
        parameter_groups[1].get_settings.return_value = (
            ("key1_1", "value1_1"),
            ("key1_2", "value1_2"),
        )
    ...
    def test_create_parameter_groups_using_stored_settings_no_settings():
        stored_settings = [
            (0, (("key0_1", "value0_1"), ("key0_2", "value0_2"))),
            (1, (("key1_1", "value1_1"), ("key1_2", "value1_2"))),
        ]

        parameter_groups = (
            ExportToFieldLogger.create_parameter_groups_using_stored_settings(
    ...
    def test_create_parameter_groups_using_stored_settings():
        ...
        stored_settings = create_test_string(
            ExportToFieldLogger.update_stored_settings(parameter_groups)
        )
    ...
    def test_create_parameter_groups_using_stored_settings_nonexisting_variable_name():
        stored_settings = [
            (
                ...
                (
                    (
                        "parameter_input_field_lNONEXISTING",
                        ["p1.u1;it1:h1, p2.u2;it2:h2"],
                    ),
                    ("key0_2", "value0_2"),
                ),
    ...
    def test_create_parameter_groups_using_stored_settings_nonexisting_variable_name_empty_result():
        stored_settings = [
            (
                0,
                (
                    ("parameter_liöst", ["p1.u1;it1:h1, p2.u2;it2:h2"]),
                    ("key0_2", "value0_2"),
                ),
            ),
    ...
    def test_create_parameter_browser_using_stored_settings():
        ...
        stored_settings = [
            (
                0,
                (
                    ("input_field_list", ["p1.u1;it1:h1", "p2.u2;it2:h2"]),
                    ("key0_2", "value0_2"),
                ),
            ),
            (1, (("location_suffix", "value1_1"), ("key1_2", "value1_2"))),
        ...
        ExportToFieldLogger.update_parameter_browser_using_stored_settings(
            stored_settings, parameter_browser
        )

        test_string = create_test_string(
            ExportToFieldLogger.update_stored_settings([parameter_browser])
        )
    ...
    def test_create_parameter_browser_using_stored_settings_nonexisting_variable_name():
        ...
        stored_settings = [
            (
                0,
                (
                    ("input_field_lNONEXISTING", ["p1.u1;it1:h1", "p2.u2;it2:h2"]),
                    ("key0_2", "value0_2"),
                ),
            ),
            (1, (("location_suffix", "value1_1"), ("key1_2", "value1_2"))),
    ...
    def test_get_stored_settings_real_parameter_name():
        mock_ms = MagicMock()
        mock_ms.settingsdict = {
            "fieldlogger_pgroups": '((0, ("input_field_group_list", ["Aveflow.m3/s;numberDecimal|numberSigned;measure flow", "Accflow.m3;numberDecimal|numberSigned;measure flow"])))'
        }
            ...
            (
                ...
                (
                    (
                        "input_field_group_list",
                        [
                            "Aveflow.m3/s;numberDecimal|numberSigned;measure flow",
                            "Accflow.m3;numberDecimal|numberSigned;measure flow",
                        ],
                    ),
                    ("key0_2", "value0_2"),
                ),
    ...
    def test_get_stored_settings_parameter_browser_real_parameter_name():
        mock_ms = MagicMock()
        mock_ms.settingsdict = {
            "fieldlogger_pbrowser": '[(0, ("input_field_group_list", ["Aveflow.m3/s;numberDecimal|numberSigned;measure flow", "Accflow.m3;numberDecimal|numberSigned;measure flow"]))]'
        }
    ...
    def test_create_export_printlist_assert_empty_input_field_group_list(
        ...
        stored_settings = [
            (
                0,
                (
                    ("final_parameter_name", "par1"),
                    ("sublocation_suffix", "group"),
        ...
        printlist = ExportToFieldLogger.create_export_printlist(
    ...
    def test_create_export_printlist_assert_no_latlon(mock_messagebar):
        ...
        stored_settings = [
            (
                0,
                (
                    ("input_field_group_list", ["p1.u1;it1:h1 "]),
                    ("sublocation_suffix", "proj.group"),
                    ("location_suffix", "proj"),
                ),
            )
        ]
    ...
    def test_create_export_printlist(mock_messagebar):
        ...
        stored_settings = [
            (
                0,
                (
                    ("input_field_group_list", ["par1;type1;hint1"]),
                    ("sublocation_suffix", "group"),
                    ("location_suffix", "proj"),
                ),
            ),
            (
                1,
                (
                    ("input_field_group_list", ["par2;type2;hint2"]),
                    ("sublocation_suffix", "group"),
    ...
    def test_create_export_printlist_duplicate_parameters(mock_messagebar):
        ...
        stored_settings = [
            ...
            (
                1,
                (
                    ("input_field_group_list", ["par1;type2;hint2"]),
                    ("sublocation_suffix", "group2"),
                    ("location_suffix", "proj"),
                ),
            ),
        ]
        ...
        stored_settings = [
            (
                ...
                (
                    (
                        "input_field_group_list",
                        ["p1.u1;it1:h1", "l.comment;test;make a comment"],
                    ),
                    ("location_suffix", "ls"),
                    ("sublocation_suffix", "with_p1_u1_and_l_comment"),
                ),
            ),
            (
                1,
                (
                    ("input_field_group_list", ["comment;test;make a general comment"]),
                    ("location_suffix", "ls"),
                    ("sublocation_suffix", "with_comment"),
                ),
            ),
        ]
    ...
    def test_create_export_printlist_not_same_latlon2(mock_messagebar):
        ...
        stored_settings = [
            ...
            (
                2,
                (
                    ("input_field_group_list", ["par3;type3;hint3"]),
                    ("sublocation_suffix", "group3"),
                    ("location_suffix", "proj"),
                ),
            ),
        ]
        ...
        stored_settings = [
            (
                ...
                (
                    (
                        "input_field_group_list",
                        ["par1;type1;hint1", "par2;type2;hint2"],
                    ),
                    ("sublocation_suffix", "group1"),
                    ("location_suffix", "proj"),
                ),
    ...
    @mock.patch("midvatten.tools.export_fieldlogger.common_utils.MessagebarAndLog")
    @mock.patch(
        "midvatten.tools.export_fieldlogger.qgis.PyQt.QtWidgets.QInputDialog.getText"
    )
    ...
    def test_create_parameter_groups_using_stored_settings_string(
        ...
        mock_iface,
        mock_tables_columns,
        mock_settingsstrings,
        mock_settingsbarandlog,
        mock_popup,
    ):
        ...
        mock_settingsstrings.side_effect = [
            (
        ...
        stored_settings = [
            (
                ...
                (
                    (
                        "input_field_group_list",
                        ["par4;type1;hint1", "par1;type1;hint1"],
                    ),
                    ("sublocation_suffix", "group"),
                    ("location_suffix", "proj"),
                ),
    ...
    def test_laton_from_vectorlayer(
        ...
        geometries = [
            QgsGeometry.fromWkt("POINT(1000000.0 100000.0)"),
            QgsGeometry.fromWkt("POINT(2000000.0 200000.0)"),
            QgsGeometry.fromWkt("POINT(3000000.0 300000.0)"),
        ]

        self.vlayer = create_vectorlayer(
            _fields, data, geometries=geometries, geomtype="Point", crs=3006
        )
    ...
    def test_laton_from_vectorlayer_fieldform(
        ...
        ref__ = {
            "settings": {"use_standard_time": "YES"},
            "inputfields": {
                "value": {"type": "number"},
                "comment": {"type": "text", "hint": "place a comment"},
                "reliable": {
                    "type": "choice",
                    "hint": "is this measurement reliable?",
                    "options": ["yes", "no"],
                },
                "photo": {"type": "photo", "hint": "take a picture"},
            },
            "groups": {
                "group_1": {"name": "Group 1", "color": "orange"},
                "group_2": {"name": "Group 2", "color": "blue"},
            },
            "locations": {
                "location_1": {
                    "lat": 51.9,
                    ...
                    "sublocations": {
                        "loc_1_1": {
                            "inputfields": ["value", "reliable", "comment"],
                            "photo": "loc_1.png",
                            "properties": {
                                "surface level": "20.74",
                                "filter level": 18.64,

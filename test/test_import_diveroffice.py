...
class TestParseDiverofficeFile:
    ...
    def test_parse_diveroffice_file_utf8(self):
        ...
        with common_utils.tempinput("\n".join(f), charset_of_diverofficefile) as path:
            file_data = DiverofficeImport.parse_diveroffice_file_old(
    ...
    def test_parse_diveroffice_comma_missing_head_cm_value(self, mock_messagebar):
        ...
        charset_of_diverofficefile = "utf-8"
        with common_utils.tempinput(
            "\n".join(f), charset_of_diverofficefile, suffix=".csv"
        ) as path:
...
class TestFilterDatesFromFiledata:
    ...
    def test_filter_dates_from_filedata(self):
        ...
        test_file_data = utils_for_tests.create_test_string(
            DiverofficeImport.filter_dates_from_filedata(
                file_data, obsid_last_imported_dates
            )
        )

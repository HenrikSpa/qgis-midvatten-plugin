...
@attr(status="on")
class TestWlvllogImportFromDiverofficeFiles(
    ...
    def test_wlvllogg_import_from_diveroffice_files_no_pandas(self):
        ...
        with common_utils.tempinput(
            "\n".join(files[0]), DiverofficeImport.charsetchoosen
        ) as f1:
            with common_utils.tempinput(
                ...
                with common_utils.tempinput(
                    ...
                    @mock.patch(
                        "midvatten.tools.import_diveroffice.midvatten_utils.select_files"
                    )
        ...
        with common_utils.tempinput(
            ...
            with common_utils.tempinput(
                ...
                with common_utils.tempinput(
                    ...
                    with common_utils.tempinput(
                        "\n".join(files[3]), DiverofficeImport.charsetchoosen
                    ) as f4:
                        with common_utils.tempinput(
                            "\n".join(files[4]), DiverofficeImport.charsetchoosen
                        ) as f5:
                            ...
                            def _test_wlvllogg_import_from_diveroffice_files(
                                ...
                                mock_notfoundquestion.return_value.answer = "ok"
                                mock_notfoundquestion.return_value.value = "rb1"
                                mock_notfoundquestion.return_value.reuse_column = (
                                    "location"
                                )
                                mock_filenames.return_value = filenames
                                mock_encoding.return_value = ["utf-8"]
                ...
                with common_utils.tempinput(
                    ...
                    with common_utils.tempinput(
                        ...
                        with common_utils.tempinput(
                            ...
                            mock_askuser = _test_wlvllogg_import_from_diveroffice_files(
                                self, filenames
                            )
                            print(str(mock_askuser.mock_calls))
                ...
                with common_utils.tempinput(
                    ...
                    with common_utils.tempinput(
                        ...
                        with common_utils.tempinput(
                            ...
                            @mock.patch(
                                "midvatten.tools.import_diveroffice.QtWidgets.QMessageBox.information"
                            )
                            @mock.patch(
                                "midvatten.tools.import_data_to_db.common_utils.NotFoundQuestion"
                            )
                            ...
                            assert (
                                mock_askuser.call_args.args[1] == "File timezone error!"
                            )
    ...
    def test_wlvllogg_import_from_diveroffice_mon_files(self):
        ...
        DiverofficeImport.charsetchoosen = "utf-8"
        with common_utils.tempinput(
            "\n".join(files[0]), DiverofficeImport.charsetchoosen, ".mon"
        ) as f1:
            with common_utils.tempinput(
                "\n".join(files[1]), DiverofficeImport.charsetchoosen, ".mon"
            ) as f2:
                with common_utils.tempinput(
    ...
    def test_wlvllogg_import_from_diveroffice_comma_missing_head_cm_value(self):
        ...
        DiverofficeImport.charsetchoosen = "utf-8"
        with common_utils.tempinput(
            "\n".join(files[0]), DiverofficeImport.charsetchoosen, ".csv"
        ) as f1:
            filenames = [f1]
            utils_askuser_answer_no_obj = MockUsingReturnValue(None)
            utils_askuser_answer_no_obj.result = 0

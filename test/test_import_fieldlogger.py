...
class TestFieldLoggerImporterNoDb:
    ...
    def test_prepare_w_flow_data(
        ...
        test_string = create_test_string(
            FieldloggerImport.prepare_w_flow_data(observations)
        )
    ...
    def test_prepare_w_levels_data_to_meas(self):
        ...
        test_string = create_test_string(
            FieldloggerImport.prepare_w_levels_data(observations)
        )
    ...
    def test_parse_rows_skip_empty_rows(self):
        f = [
            ...
            "Br2;12-12-2016;15:33:30;123;w_lvl",
            "Br1;12-12-2016;15:34:30;;w_lvl",
        ]
        observations = FieldloggerImport.parse_rows(f)
        test = create_test_string(observations)
        reference = utils_for_tests.create_test_string(
            [
                {
                    "date_time": "2016-12-12 15:33:30",
                    "parametername": "w_lvl",
                    "sublocation": "Br2",
                    "value": "123",
                }
    ...
    def test_prepare_w_flow_data_assert_only_ask_instrument_once(
        ...
        mock_instrument_not_found.assert_called_once_with(
            combobox_label="Instrument id:s in database for obsid obs1.\nThe last used instrument id for obsid obs1 is prefilled:",
            default_value="",
            dialogtitle="Submit instrument id",
            existing_list=[""],
            msg="Submit the instrument id for the measurement:\n obs1.sub, obs1, 2016-01-01 00:00:00, atype, aunit",
        )
    ...
    def test_prepare_w_flow_data_assert_only_ask_instrument_twice(
        ...
        expected_calls = [
            ...
            call(
                combobox_label="Instrument id:s in database for obsid obs2.\nThe last used instrument id for obsid obs2 is prefilled:",
                default_value="",
                dialogtitle="Submit instrument id",
                existing_list=[""],
    ...
    def test_load_file(self):
        ...
        with common_utils.tempinput("".join(f)) as filename:
            ...
            def _test(
                ...
                test_string = create_test_string(
                    sorted(
                        FieldloggerImport.select_file_and_parse_rows(
                            FieldloggerImport.parse_rows
                        ),
                        key=itemgetter("date_time", "parametername", "sublocation"),
                    )
                )
            ...
            reference = utils_for_tests.create_test_string(
                sorted(
                    [
                        {
                            "date_time": "2016-03-30 15:29:26",
                            "parametername": "q.comment",
                            "sublocation": "Rb1505.quality",
                            "value": "hej",
                        },
                        {
                            "date_time": "2016-03-30 15:30:39",
                            "parametername": "q.syre.mg/l",
                            "sublocation": "Rb1512.quality",
                            "value": "67",
                        },
                        {
                            "date_time": "2016-03-30 15:31:30",
                            "parametername": "s.turbiditet.FNU",
                            "sublocation": "Rb1512.sample",
                            "value": "899",
                        },
                        {
                            "date_time": "2016-03-30 15:29:26",
                            "parametername": "q.konduktivitet.µS/cm",
                            "sublocation": "Rb1505.quality",
                            "value": "863",
                        },
                        {
                            "date_time": "2016-03-30 15:30:09",
                            "parametername": "f.comment",
                            "sublocation": "Rb1615.flow",
                            "value": "gick bra",
                        },
                        {
                            "date_time": "2016-03-30 15:30:40",
                            "parametername": "q.syre.%",
                            "sublocation": "Rb1512.quality",
                            "value": "58",
                        },
                        {
                            "date_time": "2016-03-30 15:34:13",
                            "parametername": "l.meas.m",
                            "sublocation": "Rb1608.level",
                            "value": "555",
                        },
                        {
                            "date_time": "2016-03-30 15:30:39",
                        ...
                        {
                            "date_time": "2016-03-30 15:31:30",
                            "parametername": "s.comment",
                            "sublocation": "Rb1202.sample",
                            "value": "hej2",
                        },
                        {
                            "date_time": "2016-03-30 15:34:40",
                            "parametername": "l.comment",
                            "sublocation": "Rb1608.level",
                            "value": "testc",
                        },
                        {
                            "date_time": "2016-03-30 15:30:09",
                            "parametername": "f.Accvol.m3",
                            "sublocation": "Rb1615.flow",
                            "value": "357",
                        },
                        {
                        ...
                        {
                            "date_time": "2016-03-30 15:30:39",
                            "parametername": "q.temperatur.grC",
                            "sublocation": "Rb1512.quality",
                            "value": "8",
                        },
                    ],
    ...
    def test_load_file_delimitor_not_found(self):
        ...
        with common_utils.tempinput("".join(f)) as filename:
            ...
            @mock.patch(
                "midvatten.tools.import_fieldlogger.common_utils.ask_for_delimiter"
            )
            @mock.patch(
                "midvatten.tools.import_fieldlogger.midvatten_utils.QtWidgets.QFileDialog.getOpenFileNames"
            )
            ...
            def _test(
                ...
                test_string = FieldloggerImport.select_file_and_parse_rows(
                    FieldloggerImport.parse_rows
                )
                return test_string
            ...
            test_string = utils_for_tests.create_test_string(
                sorted(
                    _test(self, filename), key=itemgetter("date_time", "parametername")
                )
            )
            reference = utils_for_tests.create_test_string(
                sorted(
                    ...
                    key=itemgetter("date_time", "parametername"),
                )
            )
    ...
    def test_prepare_w_qual_field_data(self):
        ...
        test_string = create_test_string(
            FieldloggerImport.prepare_w_qual_field_data(observations)
        )
    ...
    def test_load_file_fieldform(self):
        f = [
            "LOCATION;DATE;TIME;TYPE;VALUE\n",
            "Rb1202.sample;2016-03-30;15:31:30;s.comment;hej2\n",
            "Rb1608.level;2016-03-30;15:34:40;l.comment;testc\n",
            "Rb1615.flow;2016-03-30;15:30:09;f.Accvol.m3;357\n",
            "Rb1615.flow;2016-03-30;15:30:09;f.comment;gick bra\n",
            "Rb1608.level;2016-03-30;15:34:13;l.comment;ergv\n",
            "Rb1608.level;2016-03-30;15:34:13;l.meas.m;555\n",
            "Rb1512.sample;2016-03-30;15:31:30;s.turbiditet.FNU;899\n",
            "Rb1505.quality;2016-03-30;15:29:26;q.comment;hej\n",
            "Rb1505.quality;2016-03-30;15:29:26;q.konduktivitet.µS/cm;863\n",
            "Rb1512.quality;2016-03-30;15:30:39;q.comment;test\n",
            "Rb1512.quality;2016-03-30;15:30:39;q.syre.mg/l;67\n",
            "Rb1512.quality;2016-03-30;15:30:39;q.temperatur.grC;8\n",
...
class TestCommentsImportFields:
    ...
    def test_alter_data(self):
        ...
        reference_string = create_test_string(
            [
                {
                    "date_time": "2016-01-01 00:00:00",
                    "parametername": "comment",
                    "skip_comment_import": True,
                    "sublocation": "1",
                    "value": "shared_comment",
                },
                {
                ...
                {
                    "date_time": "2016-01-02 00:00:00",
                    "parametername": "par_not_get_shared_comment",
                    "sublocation": "2",
                    "value": "1",
                },
                {
                    "date_time": "2016-01-04 00:00:00",
                    "parametername": "par_not_get_shared_comment",
                    "sublocation": "1",
                    "value": "1",
                },
                {
                    "date_time": "2016-01-03 00:00:00",
                    "parametername": "comment",
                    "sublocation": "1",
                    "value": "not_shared_comment",
                },
...
class TestObsidFilter:
    ...
    def test_alter_data(self, mock_get_all_obsids):
        ...
        reference_string = create_test_string(
            [
                {"obsid": "rb1", "sublocation": "rb1"},
                {"obsid": "rb2", "sublocation": "rb2"},
            ]
        )
        print(test_string)
...
def _test_set_parameters_using_stored_settings(
    ...
    stored_settings = [
        ["s.comment", [["import_method", "comments"]]],
        ["l.meas.m", [["import_method", "w_levels"], ["value_column", "level_masl"]]],
        [
            "f.Accvol.m3",
            [["import_method", "w_flow"], ["flowtype", "Accvol"], ["unit", "m3"]],
        ],
        [
            "s.turbiditet.FNU",
            [
                ["import_method", "w_qual_field"],
                ["parameter", "turbiditet"],
                ["unit", "FNU"],
                ["depth", "1"],
                ["instrument", "testid"],
            ],
    ...
    input_fields.parameter_imports = OrderedDict(
        [
            (k, import_fieldlogger.ImportMethodChooser(k))
            for k in [x[0] for x in stored_settings]
        ]
    )
...
def _test_SublocationFilter():
    ...
    assert "{sublocation: a.1}" == create_test_string(
        sublocation_filter.alter_data({"sublocation": "a.1"})
    )

    sublocation_filter.set_selection(["a.1"], False)
    assert sublocation_filter.alter_data({"sublocation": "a.1"}) is None
    assert "{sublocation: a.2}" == create_test_string(
        sublocation_filter.alter_data({"sublocation": "a.2"})
    )

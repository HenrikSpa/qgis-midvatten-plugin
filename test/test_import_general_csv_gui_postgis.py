...
class TestGeneralCsvGui(utils_for_tests.MidvattenTestPostgisDbSv):
    ...
    def test_import_w_levels_obsid_not_in_db(self):
        ...
        with common_utils.tempinput("\n".join(file), "utf-8") as filename:
            ...
            reference_string = (
                r"""(True, [(rb2, 2016-03-15 10:30:00, 5.0, None, None, None)])"""
            )
            assert test_string == reference_string

    def test_import_vlf_data_obsid_not_in_db(self):
        file = ["obsid,length2,real_comp,imag_comp,comment", "obsid2,500,2,10,acomment"]
    ...
    def test_import_w_levels_many_rows(self):
        ...
        file.extend(
            [
                "rb1," + datetime.datetime.strftime(adate, "%Y%m%d %H%M") + ",0.5"
    ...
    def test_import_w_levels_obsid_from_selection(self):
        file = ["date_time,meas", "2016-03-15 10:30:00,5.0"]
    ...
    def test_import_meteo_two_header_columns_same_name(self):
        file = [
            "obsid,instrumentid,parameter,date_time,reading_num,reading_num,aunit",
        ...
        with common_utils.tempinput("\n".join(file), "utf-8") as filename:
            ...
            test_string = utils_for_tests.create_test_string(
                db_utils.sql_load_fr_db(
                    """select obsid, instrumentid, parameter, date_time, reading_num, reading_txt, unit, comment from meteo"""
                )
            )
    ...
    def test_import_w_levels_static_value(self):
        ...
        with common_utils.tempinput("\n".join(file), "utf-8") as filename:
            ...
            reference_string = (
                r"""(True, [(rb1, 2016-03-15 10:30:00, 5.0, None, None, a comment)])"""
            )
            assert test_string == reference_string

    def test_import_w_levels_slash_in_date_time(self):
        file = ["obsid,date_time,meas", "rb1,2016/03/15 10:30,5.0"]
        ...
        with common_utils.tempinput("\n".join(file), "utf-8") as filename:
            ...
            reference_string = (
                r"""(True, [(rb1, 2016-03-15 10:30, 5.0, None, None, None)])"""
            )
            assert test_string == reference_string
    ...
    def test_import_w_levels_factor(self):
        ...
        with common_utils.tempinput("\n".join(file), "utf-8") as filename:
            ...
            reference_string = (
                r"""(True, [(rb1, 2016-03-15 10:30:00, 12.5, None, None, None)])"""
            )
            print(str(test_string))
            assert test_string == reference_string
...
class TestGeneralCsvGuiFromLayer(utils_for_tests.MidvattenTestPostgisDbSv):
    ...
    def create_and_select_vlayer(self):
        ...
        print(
            "2. QgsVectorLayer.selectedFeatureIds: "
        ...
        print(
            "4. QgsVectorLayer.getFeature(): "
            + str([self.vlayer.getFeature(x).id() for x in feature_ids])
        )
        print(
            "5. QgsVectorLayer.getFeature() type: "
    ...
    def test_import_obs_points_from_layer(self):
        db_utils.sql_alter_db(
            """INSERT INTO obs_points (obsid, geometry) VALUES ('1', ST_GeomFromText('POINT(633466 711659)', 3006))"""
        )
        ...
        reference_string = (
            r"""(True, [(1, POINT(633466 711659)), (2, POINT(633466 711659))])"""
        )
        print(str(test_string))
    ...
    def test_import_obs_points_from_layer_other_srid(self):
        ...
        self.vlayer = utils_for_tests.create_vectorlayer(
            _fields,
            data,
            geometries,
            "Point",
        ...
        test_string = utils_for_tests.create_test_string(
            db_utils.sql_load_fr_db(
                """SELECT obsid, round(east), round(north) FROM obs_points;"""
            )
        )

...
class TestInterlab4ImporterDB(utils_for_tests.MidvattenTestPostgisDbSv):
    ...
    def test_interlab4_connection_table(self):
        ...
        db_utils.sql_alter_db(
            """INSERT INTO zz_interlab4_obsid_assignment (specifik_provplats, provplatsnamn, obsid) VALUES ('Demo', 'Demo1 vattenverk', 'obsid1')"""
        )
        db_utils.sql_alter_db(
            """INSERT INTO zz_interlab4_obsid_assignment (specifik_provplats, provplatsnamn, obsid) VALUES ('Demo', 'Demo2 vattenverk', 'obsid2')"""
        )
    ...
    def test_interlab4_connection_table_only_1(self):
        ...
        test_string = utils_for_tests.create_test_string(
            db_utils.sql_load_fr_db("""SELECT * FROM zz_interlab4_obsid_assignment""")
        )
        ...
        with common_utils.tempinput("\n".join(interlab4_lines), "utf-8") as filename:
            ...
            def _test(
                ...
                gui_utils.set_combobox(
                    importer.specific_meta_filter.combobox, "lablittera", False
                )

...
class StratigraphyMixin:
    def create_and_select_vlayer(self):
        ...
        print(
            "4. QgsVectorLayer.getSelectedFeatures: "
    ...
    def test_stratigraphy(self, mock_skippopup, mock_messagebar):
        ...
        dlg.show_survey()
        print(str(mock_skippopup.mock_calls))
        test = string_utils.anything_to_string_representation(dlg.data)
        test_survey = string_utils.anything_to_string_representation(
            repr(dlg.data["1"])
        )
        test_strata = string_utils.anything_to_string_representation(
            string_utils.returnunicode(dlg.data["1"].strata, keep_containers=True)
        )
        ...
        assert (
            test
            == """{"1": SURVEY('1', 5.000000, '<QgsPointXY: POINT(633466 711659)>')}"""
        )
        assert (
            test_survey
            == '''"SURVEY('1', 5.000000, '<QgsPointXY: POINT(633466 711659)>')"'''
        )
    ...
    def test_stratigraphy_with_other_obsid_numbers(
        ...
        test_strata = string_utils.anything_to_string_representation(
            string_utils.returnunicode(dlg.data["8"].strata, keep_containers=True)
        )
        ...
        assert (
            test
            == """{"8": SURVEY('8', 5.000000, '<QgsPointXY: POINT(633466 711659)>')}"""
        )
        assert (
            test_survey
            == '''"SURVEY('8', 5.000000, '<QgsPointXY: POINT(633466 711659)>')"'''
        )
        print("Test strata " + test_strata)
        assert (
            test_strata
    ...
    def test_stratigraphy_with_string_obsid(self, mock_skippopup, mock_messagebar):
        ...
        test_strata = string_utils.anything_to_string_representation(
            string_utils.returnunicode(dlg.data["P1"].strata, keep_containers=True)
        )
        ...
        assert (
            test
            == """{"P1": SURVEY('P1', 5.000000, '<QgsPointXY: POINT(633466 711659)>')}"""
        )
        assert (
            test_survey
            == '''"SURVEY('P1', 5.000000, '<QgsPointXY: POINT(633466 711659)>')"'''
        )
        print("Test strata " + test_strata)
        assert (
            test_strata
    ...
    def test_stratigraphy_missing_h_gs(self, mock_skippopup, mock_messagebar):
        ...
        assert (
            test
            == """{"1": SURVEY('1', 5.000000, '<QgsPointXY: POINT(633466 711659)>'), "2": SURVEY('2', 10.000000, '<QgsPointXY: POINT(6720727 16568)>'), "3": SURVEY('3', -1.000000, '<QgsPointXY: POINT(6720728 16569)>')}"""
        )

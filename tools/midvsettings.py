...
class MidvSettings(object):
    ...
    def createsettingsdict(
        self,
    ):  # Here is where an empty settings dictionary is defined, NOTE! byte strings in dictionary
    ...
    def reset_settings(self):
        ...
        )  # calling for the method that defines an empty dictionary of settings

...
class TestDrillreport(utils_for_tests.MidvattenTestSpatialiteDbSv):
    ...
    def test_drillreport(self, mock_skippopup, mock_messagebar, openurl):
        ...
        #src='/home/henrik/Sync/pythoncode/henrikspa/midvatten/tools/
        report = re.sub('''src="[a-zA-ZåäöÅÄÖ0-9/]+midvatten/tools/''', '''src="midvatten/tools/''', report)
        report = re.sub('''src='[a-zA-ZåäöÅÄÖ0-9/]+midvatten/tools/''',
                        '''src='midvatten/tools/''', report)
        print(str(report))

...
from midvatten.tools.utils.db.backends.sqlite import sqlite_internal_tables
from midvatten.tools.utils.db.backends.postgresql import postgis_internal_tables
